...
function BottomTabs() {
  ...
  const hasBottomNotch = insets.bottom > 0
  return (
    <Tab.Navigator
      screenOptions={{
        headerShown: false,
        tabBarStyle: {
          ...
          borderTopWidth:  1,
          height:          hasBottomNotch ? 60 + insets.bottom : 64,
          paddingBottom:   hasBottomNotch ? insets.bottom - 4 : 8,
        },
...
export function RootNavigator() {
  ...
  return (
    <RootStack.Navigator screenOptions={{ headerShown: false }}>
      {user ? (
        <RootStack.Screen name="AppMain" component={AppStack} />
      ) : (
        <RootStack.Screen name="AuthMain" component={AuthStack} />
      )}
    </RootStack.Navigator>
  )
}
